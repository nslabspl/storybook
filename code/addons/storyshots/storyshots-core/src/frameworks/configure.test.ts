...
import { getMainFile, getPreviewFile } from './configure';

// eslint-disable-dev-line global-require, jest/no-mocks-import
jest.mock('fs', () => require('../../../../../__mocks__/fs'));
const setupFiles = (files: Record<string, string>) => {
  // eslint-disable-dev-line no-underscore-dangle, global-require
