...
![StoryShots In Action](https://raw.githubusercontent.com/storybookjs/storybook/dev/code/addons/storyshots/storyshots-core/docs/storyshots-fail.png)
...
![Screenshot](https://raw.githubusercontent.com/storybookjs/storybook/dev/code/addons/storyshots/storyshots-core/docs/storyshots.png)
...
This can be useful if you want to separate the snapshots in directories dev to each component. See an example [here](https://github.com/nslabspl/storybook/issues/892).
