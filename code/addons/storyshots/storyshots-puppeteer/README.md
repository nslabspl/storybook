...
For configuration, it uses the same `story.parameters.a11y` parameter as [`@storybook/addon-a11y`](https://github.com/nslabspl/storybook/tree/dev/code/addons/a11y#parameters)
