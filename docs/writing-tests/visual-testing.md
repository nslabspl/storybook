...
For a self-managed alternative to Chromatic, we offer [StoryShots](https://github.com/nslabspl/storybook/tree/main/addons/storyshots). It allows you to run visual tests on stories by integrating with [jest-image-snapshot](https://github.com/nslabspl/storybook/tree/main/addons/storyshots/storyshots-puppeteer#imagesnapshots).
