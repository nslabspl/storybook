...
Out of the box, Storybook's accessibility addon includes a set of accessibility rules that cover most issues. You can also fine-tune the [addon configuration](https://github.com/nslabspl/storybook/tree/next/code/addons/a11y#parameters) or override [Axe's ruleset](https://github.com/nslabspl/storybook/tree/next/code/addons/a11y#handling-failing-rules) to best suit your needs.
